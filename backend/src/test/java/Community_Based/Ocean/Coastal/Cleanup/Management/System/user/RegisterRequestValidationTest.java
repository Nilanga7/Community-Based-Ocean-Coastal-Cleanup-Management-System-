...
/**
 * Exercises RegisterRequest's Bean Validation annotations end-to-end through the test-only
 * RegisterRequestTestController, reusing GlobalExceptionHandler's MethodArgumentNotValidException
 * handling from Step 4 — the same 400/ErrorResponse pipeline a real /auth/register controller
 * will get for free once it exists.
 */
@SpringBootTest
@ActiveProfiles("test")
...
class RegisterRequestValidationTest {
    ...
    void blankEmail_failsValidationWith400AndFieldMessage() throws Exception {
        ...
        mockMvc.perform(post("/test-only/register")
