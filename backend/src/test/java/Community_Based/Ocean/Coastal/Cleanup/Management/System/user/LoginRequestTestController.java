 ...
 * exercise LoginRequest's Bean Validation annotations through a real HTTP request (validation
 * failure -> GlobalExceptionHandler -> shared ErrorResponse shape), since the real
 * POST /auth/login controller doesn't exist yet.
 */
@RestController
@RequestMapping("/test-only")
public class LoginRequestTestController {
